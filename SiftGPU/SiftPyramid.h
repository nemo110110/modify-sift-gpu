////////////////////////////////////////////////////////////////////////////
//	File:		SiftPyramid.h   sift之生成高斯金字塔
...
/////////////////////////////////////////////////////////////////////////////
//class SiftPyramid
//description: virutal class of SIFT data pyramid    虚拟类sift金字塔数据
...
public:
	...
	//image size related
	//first octave
	int			_octave_min;  //高斯金字塔最底层
	//how many octaves
	int			_octave_num; //6层金字塔
	//pyramid storage
	int			_pyramid_octave_num;  //6层金字塔
	int			_pyramid_octave_first; // 第一层金字塔
	int			_pyramid_width;  //金字塔宽度
	int			_pyramid_height;//金字塔高度
	int			_down_sample_factor;//降采样因子
	int			_allocated;  //分配
	int		    _alignment;//对准
    int         _siftgpu_failed;
public:
	vector<float>	_keypoint_buffer; //buffer缓冲
